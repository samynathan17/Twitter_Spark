...
public class Gigasearch {
	...
	public static void main(String[] args) throws Exception{
		...
		do{
			...
			String input_link="http://52.76.13.148:8000/search?format=xml&q="+ URLEncoder.encode(query, "UTF-8")+"&n=10";
			...
			do{
				...
				org.jsoup.nodes.Document doc2 = Jsoup.parse(getsource("http://52.76.13.148:8000/get?c=main&d="+htmlstring[i]), "UTF-8");
				System.out.println("http://52.76.13.148:8000/get?c=main&d="+htmlstring[i]);
				...
				if(Resulttext[i]!=null && !Resulttext[i].isEmpty())
				{
					...
					if(Domain_name.equals("singaporemotherhood.com"))
					{
						...
						try
						{
							...
							Label excel_userlink = new Label(9, ex1,user_link);
							wsheet.addCell(excel_userlink);
							Label excel_username = new Label(10, ex1,user_name);
						...
						if(Domain_name.equals("www.renotalk.com"))
						{
							try
							{
								...
								Label excel_user1 = new Label(9, ex1,userdetails[0]);
								wsheet.addCell(excel_user1);
								Label excel_user2 = new Label(10, ex1,userdetails[1]);
								wsheet.addCell(excel_user2);
								Label excel_user3 = new Label(11, ex1,userdetails[2]);
								wsheet.addCell(excel_user3);
								Label excel_user4 = new Label(12, ex1,userdetails[3]);
								wsheet.addCell(excel_user4);
								Label excel_user5 = new Label(13, ex1,userdetails[4]);
				...
				/*
							...
							if(Domain_name.equals("www.sgcarmart.com"))
							{
								try
								{
									Elements userclass=classname.parents();

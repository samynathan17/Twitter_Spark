...
public class twitterStream {
	...
	public List<Status> execute() throws TwitterException, IOException,
		...
		final GeoParser parser = GeoParserFactory.getDefault("/home/bigtapp/Desktop/IndexDirectory");
...
// twitter crawl data and add excel sheet
					// user_id
...
// user tweets
	...
	// applay nlp for user tweets
					...
					wsheet.addCell(excel_keyword_sentiment1);
					 ...
					 System.out.println("**** GEO Extraction ****");
